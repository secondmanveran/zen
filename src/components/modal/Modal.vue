    ...
    <div
      ...
      <div
        ...
        :class="[
          classes.backdrop,
          visible
            ? 'ease-out duration-200 opacity-30 dark:opacity-70'
            : 'ease-in duration-100 opacity-0'
        ]"></div>

      <div
        class="flex items-end sm:items-center justify-center p-4 sm:p-6 h-screen">
        <div
          ref="modalRef"
          :class="[
            classes.modal,
          ...
          <div
            ...
            :class="[
              ...
              $slots.image
                ...
                : 'bg-gray-500 text-gray-800 dark:text-gray-300'
            ]"
            @click="close">
          ...
          <x-scroll v-if="$slots.default" :scrollbar="false" vertical>
