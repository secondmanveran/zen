...
const props = defineProps({
  ...
  textAlign: {
    ...
    validator: (value: string) => {
      const textAlignment = ['left', 'center', 'right', 'justify']
...
<template>
  <th
    ...
    :class="[
      {
        // sort
        'cursor-pointer hover:text-gray-800 dark:hover:text-gray-300 transition-colors duration-150 ease-in-out':
          sortable,
        // stickyHeader
    ...
    <div v-if="sortable" class="relative inline-block">
      <slot></slot>
