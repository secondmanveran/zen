...
function add(notification: NotificationEvent) {
  ...
  merged.style = Object.keys(cssVariables)
...
<template>
  ...
  <teleport to="body">
    <div
      ...
      <transition-group
        tag="ul"
        :class="[classes.list, { 'flex-col-reverse': internalPosition }]"
        ...
        <li
          ...
          <div class="flex items-center flex-wrap">
            <span v-if="notification.title" class="font-semibold mr-2">{{
              notification.title
            }}</span>
          ...
          <div
            ...
            class="ml-3 font-semibold cursor-pointer text-[color:var(--x-notification-action)] hover:text-[color:var(--x-notification-action-hover)] dark:text-[color:var(--x-notification-dark-action)] dark:hover:text-[color:var(--x-notification-dark-action-hover)]"
